...
* Running ultrapoint node, linked to private/public testnet. 
  By default, tests expect daemon running at ```localhost:27090```,
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/ultrapoint/testnet_pvt```. 
